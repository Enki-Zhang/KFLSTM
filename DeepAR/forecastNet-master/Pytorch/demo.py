...
train_x, train_y, test_x, test_y, valid_x, valid_y, period = generate_data(T=2750, period=20, n_seqs=4)
# train_data, test_data, valid_data, period = generate_data(T=1000, period = 10)

# Model parameters
model_type = 'dense'  # 'dense' or 'conv', 'dense2' or 'conv2'
in_seq_length = 3 * period
