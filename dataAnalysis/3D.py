...
Z = np.array(
    [
        ...
        [2.212, 2.073831, 1.632972, 1.80034, 1.49148, 1.647969, 1.454848],
        [1.3653, 1.304647, 0.92866, 0.9303072, 0.778163, 0.578101, 0.5134832],
        [0.522213, 0.387917,0.38075, 0.4136, 0.486,0.51915, 0.638179],
...
ax.set_ylabel('batch size', color='black')
ax.set_zlabel('MAE', color='black')
