...
# 读取数据
rowdata = pd.read_csv('海门湾label=4(0).csv')
...
train_fea = rowdata0[0:10500, 0:4]
train_label = rowdata1[0:10500, 4]

test_fea = rowdata0[10500:, 0:4]
test_label = rowdata1[10500:, 4]
...
np.savetxt("LRTRUE.csv", test_label)
np.savetxt("LRTPRE.csv", preds)
# 绘图进行比较
