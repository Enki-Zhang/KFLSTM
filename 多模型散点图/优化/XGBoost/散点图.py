...
plt.text(0.82, 0.28, fr'$R^2_{{\mathrm{{train}}}}={0.83:.2f}$',ha='center', va='center',
         transform=plt.gca().transAxes, fontdict={'family': 'serif', 'style':'oblique','size': 20})
plt.text(0.82, 0.18, fr'$R^2_{{\mathrm{{test}}}}={0.77:.2f}$',ha='center', va='center',
         transform=plt.gca().transAxes, fontdict={'family': 'serif', 'style':'oblique','size': 20})

lr_label = plt.text(15.60, -0.49,
                    f'(e)XGBoost', ha='right', va='bottom',fontsize=20 )
# 设置LR标签背景颜色为灰色
