...
plt.scatter(observed, predictedKFGRU, label='Test set',marker='o',color='blue')
plt.text(0.85, 0.18, fr'$R^2={0.87:.2f}$', ha='center', va='center', transform=plt.gca().transAxes, fontdict={'family': 'serif', 'style':'oblique','size': 20})
# 添加标签
lr_label = plt.text(11.42, -0.35,
                    f'(e)KF-GRU', ha='right', va='bottom',fontsize=20 )
# 设置LR标签背景颜色为灰色
